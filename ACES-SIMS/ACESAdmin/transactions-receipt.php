...
if($ROLECHECK == "MODERATOR"){
  ...
  $query = "SELECT * FROM `transaction` WHERE TRANSACTION_CODE = '$TRANSACTION_ID';";
  $result = mysqli_query($conn, $query);
  $row = $result->fetch_assoc();

  // , SUM(TOTAL) AS SUBTOTAL 

  $sub = "SELECT SUM(TOTAL) AS SUBTOTAL FROM `transaction` WHERE TRANSACTION_CODE = ' $TRANSACTION_ID';";
...
<hr>
              <div class="form-group row text-left mb-0 py-2">
                <div class="col-sm-4 py-1"> <?php do { ?>
                  ...
                  <h6>
                    Student Number: #<?php echo $user['STUDENT_NUMBER']; ?>                  </h6>
                  <h6>
    ...
    <tr><td><?php echo $row['PRODUCT_NAME']; ?></td><td><?php echo $row['QTY']; ?></td><td><?php echo $row['PRICE']; ?></td><td><?php echo $row['TOTAL']; ?></td></tr><?php } while($row = $result->fetch_assoc());?></tbody>
            ...
            <div class="form-group row text-left mb-0 py-2">
                ...
                <div class="col-sm-4 py-1">
                  <h4>
                    Cash Amount: ₱<?php echo $SUBTOTAL; ?>.00                  </h4>
                  <table width="100%">
                    <tbody><tr>
