...
if($ROLECHECK == "MODERATOR"){
  ...
  $querySTATUS = "SELECT * FROM `transaction` WHERE `STATUS` = 'PENDING';";
  ...
  if(isset($_POST['APPROVECLICK'])){
    ...
    $DATE = $_POST['date'];
      ...
      $approveupdate = "UPDATE `transaction` SET `DATEOF` = '$DATE', `STATUS`='TO-PICK-UP' WHERE `TRANSACTION_CODE` = '$TRANSID'";
                   ...
                   <?php if(!$rowSTATUS) {
                     ...
                     do { ?> 
                      <tr style="border-bottom:1px solid gray; text-align: center;">
                        ...
                        <td style="padding-top: 2.2%;"><?php echo $rowSTATUS['PRODUCT_NAME']; ?></td>
                        ...
                        <td><button type="button" id="delstaff" data-toggle="modal" data-target="#staffdel" class="act_btn" style="text-decoration: none; cursor:pointer; width: 100px; color: White; background-color: green; border: black; border-radius: 5px;">Approve</button></td> 
    ...
    <div class="modal-content">
      <div class="modal-body">
        ...
        <div class="form-group">
            <label for="sd" class="col-form-label center">Select date for pick up</label>
            
            <input style="text-align: center; background: none; border:0;" type="text" class="form-control" name="transaction_code" id="stud" >
            <input style="text-align: center; background: none; border:0;" type="date" class="form-control" name="date" id="" >

          </div>
        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
        <button name="APPROVECLICK" type="submit" class="btn btn-primary">Sched for Pick up</button>
