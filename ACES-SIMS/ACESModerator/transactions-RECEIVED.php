  ...
  $querySTATUS = "SELECT * FROM `transaction` WHERE `STATUS` = 'RECEIVED' GROUP BY TRANSACTION_CODE;";
    ...
    <section class="dashboard">
        ...
        <div class="overview">
                ...
                <span class="text"> Orders & Transactions &nbsp; </span>
                    ...
                    <a class="act_btn" href="transactions-CANCELED.php" style="text-decoration: none; cursor:pointer; width: 100px; color: #FFF; text-align: center; background-color: #249E98; border: black; border-radius: 5px;">CANCELED</a></span>                </div>
                   ...
                   <?php if(!$rowSTATUS) {
                     ...
                     do { ?> 
                      <tr style="border-bottom:1px solid gray; text-align: center;">
                        ...
                        <td style="padding-top: 2.2%;"><a href = "transactions-receipt.php?id=<?php echo $rowSTATUS['TRANSACTION_CODE']; ?>" class="act_btn" style="text-decoration: none; cursor:pointer; width: 100px; color: black; background-color: YELLOW; border: black; border-radius: 5px; ">View</a></td> 
